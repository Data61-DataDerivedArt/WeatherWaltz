...
def main():
    ...
    parser.add_argument('-T', '--title', metavar="TITLE", default='', help='Set title for piece')
    ...
    if args.outfile:
        ...
        with open(outfile, 'w') as f:
            f.write(out(dicelist, ext, args.papersize, args.landscape, signature, bass, treble, args.tempo, args.title))
        greenprint ('Dice Waltz written to {}'.format(outfile), nc)
    else:
        print (out(dicelist, ext, args.papersize, args.landscape, signature, bass, treble, args.tempo, args.title))
